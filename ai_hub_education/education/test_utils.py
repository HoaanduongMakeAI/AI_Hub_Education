import frappe
from ai_hub_education.education.doctype.fee_schedule.fee_schedule import get_fee_structure
from ai_hub_education.education.doctype.student_group.student_group import get_students
