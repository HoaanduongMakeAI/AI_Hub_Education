...
frappe.ui.form.on('Assessment Plan', {
  ...
  refresh: function (frm) {
    ...
    frm.set_query('course', function () {
      return {
        query:
          'ai_hub_education.education.doctype.program_enrollment.program_enrollment.get_program_courses',
        filters: {
  ...
  course: function (frm) {
    if (frm.doc.course && frm.doc.maximum_assessment_score) {
      frappe.call({
        method: 'ai_hub_education.education.api.get_assessment_criteria',
        args: {
