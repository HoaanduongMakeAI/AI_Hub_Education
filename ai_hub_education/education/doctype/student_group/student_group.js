  ...
  onload: function (frm) {
    ...
    if (!frm.__islocal) {
      frm.set_query('student', 'students', function () {
        ...
        return {
          query:
            'ai_hub_education.education.doctype.student_group.student_group.fetch_students',
          filters: filters,
        }
      })
    }
  ...
  refresh: function (frm) {
    if (!frm.doc.__islocal) {
      frm.add_custom_button(
        ...
        function () {
          frappe.call({
            method: 'ai_hub_education.education.api.update_email_group',
            args: {
  ...
  get_students: function (frm) {
    if (
      ...
      if (frm.doc.academic_year) {
        frappe.call({
          method:
            'ai_hub_education.education.doctype.student_group.student_group.get_students',
          args: {
            academic_year: frm.doc.academic_year,
            academic_term: frm.doc.academic_term,
            group_based_on: frm.doc.group_based_on,
