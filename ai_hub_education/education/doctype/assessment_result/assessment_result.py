...
import ai_hub_education.education
from ai_hub_education.education.api import get_assessment_details, get_grade


class AssessmentResult(Document):
	def validate(self):
		ai_hub_education.education.validate_student_belongs_to_group(
