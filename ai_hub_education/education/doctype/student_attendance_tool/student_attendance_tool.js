...
frappe.ui.form.on('Student Attendance Tool', {
  ...
  student_group: function (frm) {
    if ((frm.doc.student_group && frm.doc.date) || frm.doc.course_schedule) {
      ...
      var method =
        'ai_hub_education.education.doctype.student_attendance_tool.student_attendance_tool.get_student_attendance_records'
        ...
        frappe.confirm(
          ...
          function () {
            ...
            if (!frappe.request.ajax_count) {
              frappe.call({
                method: 'ai_hub_education.education.api.mark_attendance',
                freeze: true,
