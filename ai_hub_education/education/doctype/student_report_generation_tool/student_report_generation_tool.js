...
frappe.ui.form.on('Student Report Generation Tool', {
  ...
  refresh: function (frm) {
    ...
    frm.page.set_primary_action(__('Print Report Card'), () => {
      ...
      let url =
        '/api/method/ai_hub_education.education.doctype.student_report_generation_tool.student_report_generation_tool.preview_report_card'
  ...
  student: function (frm) {
    if (frm.doc.student) {
      frappe.call({
        method: 'ai_hub_education.education.api.get_current_enrollment',
        args: {
