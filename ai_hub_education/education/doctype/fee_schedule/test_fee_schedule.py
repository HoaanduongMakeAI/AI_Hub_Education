...
from ai_hub_education.education.doctype.fee_schedule.fee_schedule import generate_fees

# get_defaults from test_utils
from ai_hub_education.education.test_utils import get_defaults

from ai_hub_education.education.test_utils import (
