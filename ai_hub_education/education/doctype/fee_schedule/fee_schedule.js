...
frappe.ui.form.on('Fee Schedule', {
  ...
  fee_structure: function (frm) {
    if (frm.doc.fee_structure) {
      frappe.call({
        method:
          'ai_hub_education.education.doctype.fee_schedule.fee_schedule.get_fee_structure',
        args: {
...
frappe.ui.form.on('Fee Schedule Student Group', {
  student_group: function (frm, cdt, cdn) {
    ...
    if (row.student_group && frm.doc.academic_year) {
      frappe.call({
        method:
          'ai_hub_education.education.doctype.fee_schedule.fee_schedule.get_total_students',
        args: {
