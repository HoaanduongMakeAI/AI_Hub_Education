...
frappe.ui.form.on('Fee Structure', {
  ...
  make_term_wise_fee_schedule: function (frm) {
    frappe.model.open_mapped_doc({
      method:
        'ai_hub_education.education.doctype.fee_structure.fee_structure.make_term_wise_fee_schedule',
      frm: frm,
    })
  },
  ...
  make_fee_schedule: function (frm) {
    ...
    frappe.call({
      method:
        'ai_hub_education.education.doctype.fee_structure.fee_structure.make_fee_schedule',
      args: {
  ...
  get_amount_distribution_based_on_fee_plan: function (frm) {
    ...
    frappe.call({
      method:
        'ai_hub_education.education.doctype.fee_structure.fee_structure.get_amount_distribution_based_on_fee_plan',
      args: {
        fee_plan: fee_plan,
        total_amount: frm.doc.total_amount,
